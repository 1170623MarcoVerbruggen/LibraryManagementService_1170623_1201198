    ...
    protected void createBooks() {
        ...
        if(bookRepository.findByIsbn("9789720706386").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                ...
                Book book = new Book(new Isbn("9789720706386"),
        ...
        if(bookRepository.findByIsbn("9789723716160").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                authors.add(author.get(0));
                Book book = new Book(new Isbn("9789723716160"),
                        new Title("Como se Desenha Uma Casa"),
                        new Description("Como quem, vindo de países distantes fora de / si, chega finalmente aonde sempre esteve / e encontra tudo no seu lugar, / o passado no passado, o presente no presente, / assim chega o viajante à tardia idade / em que se confundem ele e o caminho. [...]"),
                        genre.get(),
                        authors,null);
        ...
        if(bookRepository.findByIsbn("9789895612864").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                authors.add(author.get(0));
                Book book = new Book(new Isbn("9789895612864"),
        ...
        if(bookRepository.findByIsbn("9782722203402").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                ...
                Book book = new Book(new Isbn("9782722203402"),
        ...
        if(bookRepository.findByIsbn("9789722328296").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                authors.add(author.get(0));
                Book book = new Book(new Isbn("9789722328296"),
                        new Title("O Principezinho"),
                        new Description("Depois de deixar o seu asteroide e embarcar numa viagem pelo espaço, o principezinho chega, finalmente, à Terra. No deserto, o menino de cabelos da cor do ouro conhece um aviador, a quem conta todas as aventuras que viveu e tudo o que viu ao longo da sua jornada."),
                        genre.get(),
                        authors,
                        "bookPhotoTest.jpg");
        ...
        if(bookRepository.findByIsbn("9789895702756").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                authors.add(author.get(0));
                Book book = new Book(new Isbn("9789895702756"),
        ...
        if(bookRepository.findByIsbn("9789897776090").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty()) {
                authors.add(author.get(0));
                Book book = new Book(new Isbn("9789897776090"),
                        new Title("O Hobbit"),
                        new Description("\"Esta é a história de como um Baggins viveu uma aventura e deu por si a fazer e a dizer coisas totalmente inesperadas...\n" +
        ...
        if(bookRepository.findByIsbn("9789896379636").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                authors.add(author.get(0));
                authors.add(author2.get(0));
                Book book = new Book(new Isbn("9789896379636"),
                        new Title("Histórias de Vigaristas e Canalhas"),
                        new Description("Recomendamos cautela ao ler estes contos: há muitos vigaristas e canalhas à solta.\n" +
        ...
        if(bookRepository.findByIsbn("9789896378905").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                authors.add(author.get(0));
                authors.add(author2.get(0));
                Book book = new Book(new Isbn("9789896378905"),
                        new Title("Histórias de Aventureiros e Patifes"),
                        new Description("Recomendamos cautela a ler estes contos: Há muitos patifes à solta.\n" +
                                "\n" +
        ...
        if(bookRepository.findByIsbn("9789896375225").isEmpty()) {
            ...
            if (genre.isPresent() && !author.isEmpty() && !author2.isEmpty()) {
                authors.add(author.get(0));
                authors.add(author2.get(0));
                Book book = new Book(new Isbn("9789896375225"),
                        new Title("Windhaven"),
                        new Description("Ao descobrirem neste novo planeta a habilidade de voar com asas de metal, os voadores de asas prateadas " +
